...
export default function FaqV2() {
  ...
  return (
    <section id="faq" className="w-full border-t border-foreground/25 pb-[8vw]">
      <div className="px-[4vw] space-y-[1.5vw] py-[4vw]">
        <p className="text-meta uppercase tracking-[0.16em] text-foreground/55">
          FAQ
        </p>
        <SplitText as="h2" className=" text-title text-foreground">
