  ...
  return (
    ...
    >
      <div className="flex w-1/2 items-center justify-center px-[2vw] max-md:w-full max-md:px-0 max-md:py-16">
        <h1
          data-hero-title
          className=" text-[10vw] leading-[0.82] tracking-tighter text-primary max-md:text-[18vw]"
        >
          <OffsetLine className="ml-[28%]">The</OffsetLine>
          <OffsetLine>Working</OffsetLine>
          <OffsetLine className="ml-[16%]">Files</OffsetLine>
        </h1>
      </div>
